...
pizzas: list[str] = ["margherita", "tuna and onions", "sausage and fries"]
statements: list[str] = ["My favourite pizza is pizza", "I like pizza with", "I sometimes order a pizza with"]
...
animals: list[str] = ["bears", "frogs", "penguins"]
statements: list[str] = ["are potentially dangerous", "there are over 6000 species of", "mate for life"]
...
""" Commented to avoid running it each time and wasting time
numbers: list[int] = []
