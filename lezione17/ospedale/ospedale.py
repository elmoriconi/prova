...
dottore1 = Dottore("Mario", "Rossi", "Pediatra", 50.55)
dottore1.setName("Giovanni")
dottore1.setLastName("Bianchi")
dottore1.setAge(33)
dottore1.setParcel(66.66)
dottore1.setSpecialization("Oncologo")
dottore1.isAValidDoctor()
print(dottore1.getAge())
print(dottore1.getName())
print(dottore1.getLastName())
print(dottore1.getParcel())
print(dottore1.getSpecialization())
print(dottore1.doctorGreet())

paziente1 = Paziente("Mario", "Rossi", "f3555gwvg5")
paziente2 = Paziente("Luca", "Maggi", "reg5342vdf")
paziente3 = Paziente("Giada", "Lini", "wdf98j32c3")
print(paziente1.getName())
